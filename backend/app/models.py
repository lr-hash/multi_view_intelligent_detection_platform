...
class BoreholeTrajectory(db.Model):
    ...
    timestamp = db.Column(db.DateTime, default=datetime.now, comment='测量时间')
...
class SupportPressureData(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    record_time = db.Column(db.DateTime, index=True, default=datetime.now, comment='记录时间')
...
class MicroseismicEvent(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    event_time = db.Column(db.DateTime, index=True, default=datetime.now, comment='事件时间')
...
class InterfaceLog(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    timestamp = db.Column(db.DateTime, index=True, default=datetime.now, comment='日志时间')
...
class AlarmRecord(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    timestamp = db.Column(db.DateTime, index=True, default=datetime.now, comment='报警时间')
